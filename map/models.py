...
class Cluster(models.Model):
    ...
    c_cluster = models.CharField(max_length = 10, verbose_name = 'Codigo del Cluster', null=False, blank=False)
    ...
    n_bandejas = models.IntegerField(
        choices = BANDEJAS_CHOICES,
        default = 1,
        verbose_name = 'Numero de Bandejas'
    )

    n_fusiones = models.IntegerField(
        choices = FUSIONES_CHOICES,
        default = 1,
        verbose_name = 'Numero de Fusiones'
    )
...
class Bandeja(models.Model):
    ...
    cluster = models.ForeignKey(Cluster, verbose_name= 'Cluster', on_delete=models.CASCADE, related_name='bandejas')
